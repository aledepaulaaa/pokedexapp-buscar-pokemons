    ...
    <div id="app">
        <div class="columns">
            <div class="column is-half-one">
                ...
                <input v-model="busca" class="input is-rounded" type="text" name="" id=""
                    placeholder="Buscar pokemon pelo nome" @keyup.enter="buscar" />
                ...
                <div v-for="(poke, index) in filteredPokemons /*resultadoBusca*/" :key="poke.url">
